    ...
    <div className="p-4 flex justify-between fixed top-0 left-0 w-full z-[9999] bg-black">
      <div className="flex items-center gap-8">
        ...
        <nav className="hidden md:flex items-center space-x-5">
          <a href="#" className="hover:text-red-700 text-white">Home</a>
          <a href="#" className="hover:text-red-700 text-white">About</a>
          <a href="#" className="hover:text-red-700 text-white">Contact</a>
        </nav>
      </div>
